    ...
    <div className="animate-fade-in">
      ...
      <div className="grid gap-4">
        ...
        <button 
            ...
            className="w-full bg-[#1e1e1e] rounded-xl shadow p-4 text-indigo-400 hover:text-indigo-300 flex flex-col items-center justify-center transition border border-dashed border-gray-700 hover:border-indigo-500 mt-2"
        >
            <i className="fas fa-user-graduate text-2xl mb-2"></i>
            <span className="text-sm font-bold">STREFA TRENERA</span>
        </button>
      </div>
    </div>
  );
